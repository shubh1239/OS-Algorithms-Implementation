...
4. LRU Page Replacement (lru_page_replacement.cpp)
Implements the Least Recently Used policy.

Unlike FIFO, LRU updates the position of a page on every Page Hit, ensuring that frequently accessed pages remain in memory.

Logic: Front of the vector represents the Least Recently Used page, while the back represents the Most Recently Used.
